...
fn main() {
    ...
    env::set_var("DEP_AWS_LC_FIPS_0_12_15_INCLUDE", &prebuilt_dir.join("include").to_str().unwrap());
    env::set_var("DEP_AWS_LC_FIPS_0_12_15_LIBCRYPTO", "aws_lc_fips_0_12_15_crypto");
    env::set_var("DEP_AWS_LC_FIPS_0_12_15_ROOT", prebuilt_dir.to_str().unwrap());
